...
##Please see "Downloading and reading the data" file in this repository if you're wondering about
...
## plotting to PNG
png("plot3.png") 
qplot(year, Emissions, data = totalpm2.5Balt2, color=type, geom ="line") + geom_point( size=5, shape=21, fill="white") + ggtitle(expression("Baltimore Maryland" ~ PM[2.5] ~ "Emmission by source, type, and year")) + xlab("Year") + ylab(expression("Total" ~ PM[2.5] ~ "Emissions (tons)"))
dev.off()
